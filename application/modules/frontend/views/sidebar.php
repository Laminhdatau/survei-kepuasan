            ...
            <div id="sidebar-menu" class="main_menu_side hidden-print main_menu ">
              <div class="menu_section">
                <ul class="nav side-menu ">
                  <li><a href="<?= base_url('frontend'); ?>"><i class="fa fa-home fa-fw" style="color:#75006a"></i> Dashboard</a></li>
                  <li><a><i class="fa fa-edit fa-fw" style="color:#75006a"></i> Kuisioner <span class="fa fa-chevron-down" style="color:#75006a"></span></a>
                    <ul class="nav child_menu">
                      <li><a href="<?= base_url('frontend/getQuisDosen'); ?>">Kuis Dosen</a></li>
                      <li><a href="<?= base_url('frontend/getquismk'); ?>">Kuis Mata Kuliah</a></li>
                    </ul>
                  </li>
