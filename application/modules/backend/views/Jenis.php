                    ...
                    <tbody>
                      ...
                      foreach ($jenis as $j) : ?>
                        ...
                        <tr>
                          ...
                          <td>
                            <a href="" data-toggle="modal" data-target="#editJenis" class="btn btn-info btn-xs"><i class="fa fa-pencil"></i></a>
      ...
      <div class="modal-body">
        <form method="post" action="<?= base_url('backend/fungsiInputJenis'); ?>" id="demo-form2" data-parsley-validate class="form-horizontal form-label-left">
          ...
          <div class="item form-group">
            <label class="col-form-label col-md-3 col-sm-3 label-align">Kuis
            </label>
...
<div class="modal fade " id="tambahJenis" tabindex="-1" role="dialog" aria-hidden="true">
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form method="post" action="<?= base_url('backend/fungsiEditJenis'); ?>" id="demo-form2" data-parsley-validate class="form-horizontal form-label-left">
          ...
          <div class="item form-group">
            ...
            <div class="col-md-6 col-sm-6 ">
              <input type="hidden" name="id_jenis_quisioner" class="form-control ">
              <input type="text" name="jenis_quisioner" class="form-control" value="<?= $q['jenis_quisioner']; ?>" required>
            </div>
          </div>
